...
conditions <- readRDS(here::here("..", "Data Clean", "conditions_more-predictors.rds"))
condition_names <- readRDS(here::here("..", "Data Clean", "condition-names_more-predictors.rds"))
#testdat <- readRDS(here::here("..", "Data Clean", "testdat_more-predictors..rds"))
helmer_stan <- readRDS(here::here("Models", "trihurdle-metaanalysis_more-predictors_model-small.rds"))
...
saveRDS(playdat_full, here::here("..", "Data Clean", "trihurdle-metaanalysis_more-predictors_playdat-full.rds"))
