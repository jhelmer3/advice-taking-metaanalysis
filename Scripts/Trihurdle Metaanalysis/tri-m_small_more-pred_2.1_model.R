...
fit <- mod$sample(data = list(N = nrow(dat_small), # number observations
...
qs2::qs_save(fit, file = here::here("Models", "tri-m_small_more-pred_model_2.1.qs"))
saveRDS(testdat, file = here::here("..", "Data Clean", "tri-m_small_more-pred_testdat.rds"))
